                    ...
                    <div class="box box-warning">
                        <div class="box-body block-images">
                            <div style="margin-bottom: 10px" class="image-area">
                                <img src="<?php echo e(pare_url_file(Auth::user()->avatar)); ?>" class="img-thumbnail" >
                            </div>
                    ...
                    <div class="edit-profile-bd" style="margin-top:10px">
                            ...
                            <div class="edit-profile-item-info">
                                <div class="mod-input floating edit-profile-input-name mod-input-name">
                                    <input type="text" name="name" id="name" placeholder="Họ Tên"
                                           value="<?php echo e(Auth::user()->name); ?>"><b></b>
                                </div>
                            </div>
                        </div>
                        <div class="edit-profile-item">
                            <h3 class="edit-profile-item-title">
                                ...
                                <div class="mod-input floating  edit-profile-item-value">
                                    <input type="text" readonly name="email" placeholder="Email" value="<?php echo e(Auth::user()->email); ?>">
                                </div>
                        </div>
                        <div class="edit-profile-item">
                            <h3 class="edit-profile-item-title">
                        ...
                        <div class="edit-profile-item">
                            <h3 class="edit-profile-item-title">
                                <span>Địa chỉ</span>
                                <div class="mod-input floating  edit-profile-item-value">
                                    <input type="text" name="address" placeholder="Địa chỉ" value="<?php echo e(Auth::user()->address); ?>">
                                </div>
                        </div>
                        <div class="edit-profile-item">
                            <h3 class="edit-profile-item-title">
                                <span>Ngày sinh</span>
                                <div class="mod-input floating  edit-profile-item-value">
                                    <input type="date" name="birthday" value="<?php echo e(Auth::user()->birthday); ?>">
                                </div>
                        </div>
                        <div class="edit-profile-item">
                            <h3 class="edit-profile-item-title">
                                ...
                                <div class="mod-input floating  edit-profile-item-value">
                                    <select name="gender" class="form-control">
                                        ...
                                        <option value="1" <?php if(Auth::user()->gender == 1): ?> selected <?php endif; ?>>Nữ</option>
                                    </select>
                                </div>
                        </div>
                        <div class="edit-profile-item">
...
<?php echo $__env->make('layout.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\tesst\resources\views/user/edit.blade.php ENDPATH**/ ?>