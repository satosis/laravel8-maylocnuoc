                    ...
                    <div class="price">
                        ...
                        <div class="lstPrice">
                            <ul>
                                ...
                                <li class="<?php echo e(Request::get('price') == 10 ? 'active' :''); ?>">
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['price' => 10]  )); ?> ">
                                        Từ 10 triệu - 25 triệu
                                    </a>
                                </li>


                                <li class="<?php echo e(Request::get('price') == 50 ? 'active' :''); ?>">
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['price' => 50]  )); ?> ">
                                        Trên 50 triệu
                                    </a>
                                </li>
                            </ul>
