...
<div class="container"><br>
    <div class="login">
        ...
        <a href="<?php echo e(url('/auth/redirect/facebook')); ?>" class="<?php echo e(isset($reset) ? 'd-none' :''); ?>  btn btn-blue"><i
    ...
    <form action="" method="POST" role="form" class="col-md-8">
        ...
        <a href="<?php echo e(route('get.home')); ?>" class="btn btn-danger"><i class="fa fa-undo"></i> Quay lại</a>

    </form>
    <br>

    <a class="<?php echo e(isset($login) ? 'd-none' :''); ?>"
       style="color:blue;text-decoration:underline;font-size:18px;line-height:24px" href="<?php echo e(route('get.login')); ?>">Đăng
        nhập</a><br>
    <a class="<?php echo e(isset($register) ? 'd-none' :''); ?>"
       style="color:blue;text-decoration:underline;font-size:18px;line-height:24px" href="<?php echo e(route('get.register')); ?>">Đăng
        ký</a><br>
    <a class="<?php echo e(isset($reset) ? 'd-none' :''); ?>"
       style="color:blue;text-decoration:underline;font-size:18px;line-height:24px"
       href="<?php echo e(route('get.forgot-password')); ?>">Quên mật khẩu</a><br>
</div>
