...
<head>
    <!--CSS-->
    <title><?php echo e($title_page ?? 'Đồng hồ Thụy Sỹ, đồng hồ nam, đồng hồ nữ chính hãng cao cấp'); ?></title>
        ...
        <ul class="menuRight dnTablet-l">
            ...
            <li class="hasChild">
                <a href="<?php echo e(route('get.user.profile')); ?>">
                    <img class="profile-user-img img-responsive img-circle" src="<?php echo e(pare_url_file(Auth::user()->avatar)); ?>" style="width:50px;height:50px;border-radius: 50%;" alt="User profile picture">
                </a>
                    <ul>
                        <li>
